...
@Slf4j
public class SynchronizedBlockGlobalCacheTest {

  @Test
  public void given_two_thread_then_block_second_thread_is_block_when_first_is_block_for_written() {
    SynchronizedBlockGlobalCache<Product> synchronizedBlockGlobalCache = new SynchronizedBlockGlobalCache<Product>();
